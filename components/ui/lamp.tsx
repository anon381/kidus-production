  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl" style={{ width: contentWidth * 0.93 }}></div>
        <motion.div
        ...
        ></motion.div>
        <motion.div
          initial={{ width: contentWidth * 0.5 }}
          whileInView={{ width: contentWidth }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
      ...
      <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5" ref={contentRef}>
        {children}
      </div>
    </div>
  );
